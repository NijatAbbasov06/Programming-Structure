...
TestStrToLong()
{
  ...
  char str9[] = "-9223372036854775808";
  char str10[] = "9223372036854775807";
  char str11[] = "92233720368547758071assd";
  char str12[] = "922337203685477580711229393929932assd14919292203";
  ...
  res2 = strtol(str10, NULL, 10);
  PRINT_RESULT(res1 == res2);
  printf("Your      Answer: [%ld]\n", res1);
  printf("String.h  Answer: [%ld]\n", res2);

  printf("Test10:\n");
  res1 = StrToLong(str10, NULL, 10);
  res2 = strtol(str10, NULL, 10);
  PRINT_RESULT(res1 == res2);
  printf("Your      Answer: [%ld]\n", res1);
  printf("String.h  Answer: [%ld]\n", res2);
  ...
  printf("Test11:\n");
  res1 = StrToLong(str11, NULL, 10);
  res2 = strtol(str11, NULL, 10);
  PRINT_RESULT(res1 == res2);
  printf("Your      Answer: [%ld]\n", res1);
  printf("String.h  Answer: [%ld]\n", res2);

  printf("Test12:\n");
  res1 = StrToLong(str12, &end1, 10);
  res2 = strtol(str12, &end2, 10);
  PRINT_RESULT((res1 == res2) && (end1 == end2));
  printf("Your      Answer: %ld, endptr char: %c (%p)\n", res1, *end1, end1);
  printf("String.h  Answer: %ld, endptr char: %c (%p)\n", res2, *end2, end2);
}
